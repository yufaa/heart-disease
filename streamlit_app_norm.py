...
model = pickle.load(open("model/rf_norm_model.pkl", 'rb'))
...
# Multiple Predict----------
  if file_uploaded:
    ...
    uploaded_norm = scaler.transform(uploaded_df)
    prediction_arr = model.predict(uploaded_norm)
